...
class db_games(commands.Cog):
	...
	async def duel(self, ctx, member : SmartMember):
		...
		duelEmbed.set_image(url="https://cdn.discordapp.com/attachments/654787316665286714/807843266262728725/HSwnjulH.gif")
		...
		if startDuel:
			...
			duelEmbed.set_image(url="https://cdn.discordapp.com/attachments/654787316665286714/807848068573036574/Xsc8tWIc.gif")
