...
class db_roles(commands.Cog):
	...
	@roles.command()
	async def color(self, ctx, role : discord.Role, newcolor : discord.Colour):
		oldcolor = role.color
	...
	@roles.command()
	async def sidebar(self, ctx,*, role : discord.Role):
		if role.hoist:
	...
	@roles.command()
	async def name(self, ctx, role : discord.Role,*, newname : str):
		oldname = role.name
	...
	@roles.command()
	async def position(self, ctx, role : discord.Role, newposition : int):
	...
	@roles.command()
	async def kick(self, ctx, role : discord.Role, hours : int):
		dawdle = ctx.guild
	...
	@roles.command()
	async def give(self, ctx, role : discord.Role, *, member : SmartMember):
	...
	@roles.command()
	async def remove(self, ctx, role : discord.Role, *, member : SmartMember):
