...
class db_pins(commands.Cog):
	...
	def __init__(self, bot):
		self.bot = bot
		self.excluded_channels = [514556004822941696, 739190354313478195, 492357669424988181, 623016717429374986, 654787316665286714, 600720406902734858, 600720406902734858, 824298501508038657]
