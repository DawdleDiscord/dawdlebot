...
class clean(commands.Cog):
	def __init__(self, bot):
		self.bot = bot
		with open('cleanbotlist.json', 'r') as json_file:
			self.bot_dict = json.load(json_file)
		del json_file
		with open('cleanchannellist.json', 'r') as json_file:
	...
	async def botadd(self, ctx, botname : str, prefix : str):
		...
		with open('cleanbotlist.json', 'w') as json_file:
	...
	async def botlist(self, ctx):
		...
		for bot in self.bot_dict.keys():
			...
			botstring = botstring+self.bot_dict[bot]
	...
	async def channeladd(self, ctx, channel : discord.TextChannel):
		...
		with open('cleanchannellist.json', 'w') as json_file:
